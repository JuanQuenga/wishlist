<div class="container mx-auto h-screen">
  <div class="text-center px-3 lg:px-0">
    <h1
      class="my-4 text-2xl md:text-3xl lg:text-5xl text-black leading-tight font-extrabold"
    >
    ...
    >
      Easily create, share, and collaborate on wishlists with friends and family!
    </p>
