<div class="w-full">
  <header class="bg-slate-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
    <div class="hidden lg:sticky lg:top-0 lg:flex lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl]">
      ...
      <span class="mt-6 flex gap-6 font-bold text-slate-900">Eric Gordon <span aria-hidden="true" class="text-slate-400">/</span>Wes Mantooth </span>
    </div>
    <div class="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:px-8 lg:py-12 xl:px-12">
      <a class="relative mx-auto block w-48 overflow-hidden rounded-lg bg-slate-200 shadow-xl shadow-slate-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl" aria-label="Homepage" href="/">
        <img alt="" fetchpriority="high" width="960" height="960" decoding="async" data-nimg="1" class="w-full" style="color:transparent" sizes="(min-width: 1024px) 20rem, (min-width: 640px) 16rem, 12rem" srcset="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=16&amp;q=75 16w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=32&amp;q=75 32w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=48&amp;q=75 48w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=64&amp;q=75 64w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=96&amp;q=75 96w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=128&amp;q=75 128w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=256&amp;q=75 256w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=384&amp;q=75 384w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=640&amp;q=75 640w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=750&amp;q=75 750w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=828&amp;q=75 828w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=1080&amp;q=75 1080w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=1200&amp;q=75 1200w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=1920&amp;q=75 1920w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=2048&amp;q=75 2048w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=3840&amp;q=75 3840w" src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=3840&amp;q=75">
      ...
      <div class="mt-10 text-center lg:mt-12 lg:text-left">
        ...
        <p class="mt-3 text-lg font-medium leading-8 text-slate-700">Conversations with the most tragically misunderstood people of our time.</p>
      </div>
              ...
              <div class="lg:max-w-4xl">
                <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                  <div class="flex flex-col items-start">
                    ...
                    <time datetime="2022-02-24T00:00:00.000Z" class="order-first font-mono text-sm leading-7 text-slate-500">February 24, 2022</time>
                    ...
                    <div class="mt-4 flex items-center gap-4">
                      <button type="button" aria-label="Play episode 5: Bill Lumbergh" class="flex items-center gap-x-3 text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900">
                      ...
                      <a class="flex items-center text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900" aria-label="Show notes for episode 5: Bill Lumbergh" href="/5">Show notes</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="lg:max-w-4xl">
                <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                  <div class="flex flex-col items-start">
                    ...
                    <time datetime="2022-02-17T00:00:00.000Z" class="order-first font-mono text-sm leading-7 text-slate-500">February 17, 2022</time>
                    <p class="mt-1 text-base leading-7 text-slate-700">When golf-obsessed terrorists kidnapped his family and held them hostage in exchange for a Golden Jacket, Shooter had no choice but to win the tour at any cost.</p>
                    <div class="mt-4 flex items-center gap-4">
                      <button type="button" aria-label="Play episode 4: Shooter McGavin" class="flex items-center gap-x-3 text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900">
                        <svg aria-hidden="true" viewBox="0 0 10 10" class="h-2.5 w-2.5 fill-current">
                          <path d="M8.25 4.567a.5.5 0 0 1 0 .866l-7.5 4.33A.5.5 0 0 1 0 9.33V.67A.5.5 0 0 1 .75.237l7.5 4.33Z"></path>
                        </svg>
                        <span aria-hidden="true">Listen</span>
                      ...
                      <span aria-hidden="true" class="text-sm font-bold text-slate-400">/</span>
                      <a class="flex items-center text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900" aria-label="Show notes for episode 4: Shooter McGavin" href="/4">Show notes</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="lg:max-w-4xl">
                <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                  <div class="flex flex-col items-start">
                    ...
                    <time datetime="2022-02-10T00:00:00.000Z" class="order-first font-mono text-sm leading-7 text-slate-500">February 10, 2022</time>
                    <p class="mt-1 text-base leading-7 text-slate-700">The Christmas of 1989 wasn’t the first time Harry and Marv crossed paths with the McCallisters. The real story starts in 1973, when Peter tripped Marv in the highschool locker room.</p>
                    <div class="mt-4 flex items-center gap-4">
                      <button type="button" aria-label="Play episode 3: The Wet Bandits" class="flex items-center gap-x-3 text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900">
                        <svg aria-hidden="true" viewBox="0 0 10 10" class="h-2.5 w-2.5 fill-current">
                          <path d="M8.25 4.567a.5.5 0 0 1 0 .866l-7.5 4.33A.5.5 0 0 1 0 9.33V.67A.5.5 0 0 1 .75.237l7.5 4.33Z"></path>
                        </svg>
                        <span aria-hidden="true">Listen</span>
                      ...
                      <span aria-hidden="true" class="text-sm font-bold text-slate-400">/</span>
                      <a class="flex items-center text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900" aria-label="Show notes for episode 3: The Wet Bandits" href="/3">Show notes</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="lg:max-w-4xl">
                <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                  <div class="flex flex-col items-start">
                    ...
                    <time datetime="2022-02-03T00:00:00.000Z" class="order-first font-mono text-sm leading-7 text-slate-500">February 3, 2022</time>
                    <p class="mt-1 text-base leading-7 text-slate-700">What looks to outsiders like a malicious plan to conquer the east coast, was actually a story of liberation and freedom if you get it straight from the source.</p>
                    <div class="mt-4 flex items-center gap-4">
                      <button type="button" aria-label="Play episode 2: Hank Scorpio" class="flex items-center gap-x-3 text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900">
                        <svg aria-hidden="true" viewBox="0 0 10 10" class="h-2.5 w-2.5 fill-current">
                          <path d="M8.25 4.567a.5.5 0 0 1 0 .866l-7.5 4.33A.5.5 0 0 1 0 9.33V.67A.5.5 0 0 1 .75.237l7.5 4.33Z"></path>
                        </svg>
                        <span aria-hidden="true">Listen</span>
                      ...
                      <span aria-hidden="true" class="text-sm font-bold text-slate-400">/</span>
                      <a class="flex items-center text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900" aria-label="Show notes for episode 2: Hank Scorpio" href="/2">Show notes</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="lg:max-w-4xl">
                <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                  <div class="flex flex-col items-start">
                    ...
                    <time datetime="2022-01-27T00:00:00.000Z" class="order-first font-mono text-sm leading-7 text-slate-500">January 27, 2022</time>
                    <p class="mt-1 text-base leading-7 text-slate-700">You know him as an evil supervillain, but his closest friends call him Jeff, and he's just doing his best to find his way in a world that doesn't know what to do with a talking skeleton.</p>
                    <div class="mt-4 flex items-center gap-4">
                      <button type="button" aria-label="Play episode 1: Skeletor" class="flex items-center gap-x-3 text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900">
                        <svg aria-hidden="true" viewBox="0 0 10 10" class="h-2.5 w-2.5 fill-current">
                          <path d="M8.25 4.567a.5.5 0 0 1 0 .866l-7.5 4.33A.5.5 0 0 1 0 9.33V.67A.5.5 0 0 1 .75.237l7.5 4.33Z"></path>
                        </svg>
                        <span aria-hidden="true">Listen</span>
                      ...
                      <span aria-hidden="true" class="text-sm font-bold text-slate-400">/</span>
                      <a class="flex items-center text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900" aria-label="Show notes for episode 1: Skeletor" href="/1">Show notes</a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <footer class="border-t border-slate-200 bg-slate-50 py-10 pb-40 sm:py-16 sm:pb-32 lg:hidden">
    <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
      ...
      <div class="mt-2 flex gap-6 text-sm font-bold leading-7 text-slate-900">Eric Gordon <span aria-hidden="true" class="text-slate-400">/</span>Wes Mantooth </div>
    </div>
  </footer>
    ...
    <div class="flex items-center gap-6 bg-white/90 px-4 py-4 shadow shadow-slate-200/80 ring-1 ring-slate-900/5 backdrop-blur-sm md:px-6">
      ...
      <div class="mb-[env(safe-area-inset-bottom)] flex flex-1 flex-col gap-3 overflow-hidden p-1">
        ...
        <div class="flex justify-between gap-6">
          ...
          <div role="group" id="react-aria3513016656-:r0:" aria-labelledby="react-aria3513016656-:r1:" class="absolute inset-x-0 bottom-full flex flex-auto touch-none items-center gap-6 md:relative">
            <label class="sr-only" id="react-aria3513016656-:r1:">Current time</label>
            <div class="relative w-full bg-slate-100 md:rounded-full" style="position: relative; touch-action: none;">
              <div class="h-2 md:rounded-l-xl md:rounded-r-md bg-slate-700" style="width: calc(3.125% - 0.25rem);"></div>
              <div class="absolute top-1/2 -translate-x-1/2" style="left: 3.125%;">
                <div class="h-4 rounded-full w-1 bg-slate-700" style="position: absolute; transform: translate(-50%, -50%); touch-action: none; left: 3.125%;">
                  <div style="border: 0px; clip: rect(0px, 0px, 0px, 0px); clip-path: inset(50%); height: 1px; margin: -1px; overflow: hidden; padding: 0px; position: absolute; width: 1px; white-space: nowrap;">
                    <input tabindex="0" id="react-aria3513016656-:r1:-0" aria-labelledby="react-aria3513016656-:r1:" min="0" max="64" step="1" aria-orientation="horizontal" aria-valuetext="0 hours, 0 minutes, 2 seconds" aria-describedby="" aria-details="" type="range" value="2">
                  </div>
                </div>
              </div>
            </div>
            <div class="hidden items-center gap-2 md:flex">
              <output for="react-aria3513016656-:r1:-0" aria-live="off" class="hidden rounded-md px-1 py-0.5 font-mono text-sm leading-6 md:block text-slate-500">00:02</output>
  ...
  <audio src="https://their-side-feed.vercel.app/episode-005.mp3"></audio>
</div>